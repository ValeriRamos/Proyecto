                    ...
                    <form class="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="content">
                            ...
                            <div class="input-group">
                                ...
                                <input  id="password-confirm" placeholder="Confirmar contraseña"  type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required   >
